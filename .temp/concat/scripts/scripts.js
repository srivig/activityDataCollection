...
.config(["$stateProvider", "$urlRouterProvider", function($stateProvider, $urlRouterProvider) {
  ...
  .state('app.existing', {
    url: "/existing/:activityUID",
    views: {
      'menuContent': {
        templateUrl: "templates/existingActivity.html",
        controller: 'existingActivityCtrl'
      }
    }
  })
  .state('app.home', {
...
.controller('AppCtrl', ["$scope", "$rootScope", "API", "$ionicModal", "$timeout", "$ionicSideMenuDelegate", "$window", function($scope, $rootScope, API, $ionicModal, $timeout, $ionicSideMenuDelegate, $window) {
  //TODO init functions...
...
--------------------------------------------**/
.controller('ActivitiesCtrl', ["$rootScope", "API", "$scope", "$window", "$stateParams", function($rootScope, API, $scope, $window, $stateParams) {
...
.controller('HomeCtrl', ["$rootScope", "API", "$scope", "$window", "$ionicModal", function($rootScope, API, $scope, $window, $ionicModal) {
...
.controller('existingActivityCtrl', ["$rootScope", "API", "$scope", "$window", "$ionicModal", "$stateParams", "$ionicPopup", function($rootScope, API, $scope, $window, $ionicModal, $stateParams,$ionicPopup) {
  /* User auth */
  if (!$rootScope.isSessionActive()) {
    $window.location.href = ('#/login');
  }
...
--------------------------------------------**/
.controller('SignUpCtrl', ["$rootScope", "$scope", "API", "$window", "$ionicPopup", "$ionicScrollDelegate", function($rootScope, $scope, API, $window,$ionicPopup,$ionicScrollDelegate) {
  $scope.user = {
    email: "",
    password: "",
    name: "",
...
.controller('ActivityCtrl', ["$scope", "$rootScope", "API", "$stateParams", "$state", "$ionicHistory", "$window", function($scope, $rootScope, API, $stateParams, $state, $ionicHistory, $window) {
  if (!$rootScope.isSessionActive()) {
    $window.location.href = ('#/login');
  }
...
angular.module('myDiaryApp.services', [])
  .factory('API', ["$rootScope", "$http", "$ionicLoading", "$window", "$ionicPopup", function($rootScope, $http, $ionicLoading, $window, $ionicPopup ) {
