...
myDiaryApp.directive('timePickerService', function(){
...
$(document).ready(function(){
  ...
  $("#slider-range").slider({
      ...
      $(_timeRangeVerticalContainer).prepend(_timeTickContainer);
        ...
        $("#_startTime").attr("value",'00:00 AM');
        $("#_endTime").attr("value",'10:00 AM');
      ...
      slide: function (e, ui) {
          ...
          $("#_endTime").attr("ng-init","activity.endTime='"+eTime+"'");
          ...
          $("#_startTime").attr("value",hours2 + ':' + minutes2);
